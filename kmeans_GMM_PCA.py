...
def compute_log_likelihood(data, prob_each_Xn_each_k, total_prob_each_Xn, k):
    ...
    total_prob_each_Xn = np.sum(prob_each_Xn_each_k, axis = 1)
    total_prob_each_Xn = np.nan_to_num(total_prob_each_Xn)
...
#            print (total_prob_each_Xn)
            ...
            responsibility_term_each_Xn_eack_k[i][j] = np.nan_to_num(responsibility_term_each_Xn_eack_k[i][j])
